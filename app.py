...
def init_db():
    ...
    # 328 articles officiels — INVENTAIRE_CN_04052026
    articles = [
        ...
        ('ART-015','Protection Individuelle','Casque anti-bruit ancien modèle','Earline 31020','',1,'','UNITE',1,0.0,'',1,0,1,0,0,'Ancien stock'),
        ...
        ('ART-025','Protection Individuelle','Lunettes sécurité ancien stock','','Bollé / Opsial',1,'','UNITE',1,0.0,'',29,0,0,0,0,'Ancien stock non utilisé'),
        ('ART-026','Protection Individuelle','Guêtres de tronçonnage cuir','TSV00008','',1,'','PAIRE',1,0.0,'',0,2,5,0,0,'À COMMANDER'),
        ('ART-027','🦺 Vêtements de travail','Gilets 3XL encadrant','','',1,'','UNITE',1,0.0,'',2,1,2,0,0,''),
        ('ART-028','🦺 Vêtements de travail','Gilets XL','','',1,'','UNITE',1,0.0,'',3,2,4,0,0,''),
        ('ART-029','🦺 Vêtements de travail','Gilets L','','',1,'','UNITE',1,0.0,'',10,3,5,0,0,''),
        ('ART-030','🦺 Vêtements de travail','Gilets M','','',1,'','UNITE',1,0.0,'',1,2,4,0,0,''),
        ('ART-031','🦺 Vêtements de travail','Gilets S','','',1,'','UNITE',1,0.0,'',5,1,3,0,0,''),
        ('ART-032','🦺 Vêtements de travail','Combinaison protection LG orange','','',1,'','UNITE',1,0.0,'',1,2,4,0,0,''),
        ('ART-033','🦺 Vêtements de travail','Combinaison protection MD orange','','',1,'','UNITE',1,0.0,'',10,2,4,0,0,''),
        ('ART-034','🦺 Vêtements de travail','Combinaison protection XL orange','','',1,'','UNITE',1,0.0,'',5,2,4,0,0,''),
        ('ART-035','🦺 Vêtements de travail','Combinaison protection 3XL orange','','',1,'','UNITE',1,0.0,'',2,1,2,0,0,''),
        ('ART-036','🦺 Vêtements de travail','Combinaison protection LG blanche','','',1,'','UNITE',1,0.0,'',22,5,10,0,0,'Stock aussi dans autre conteneur'),
        ('ART-037','🦺 Vêtements de travail','Ensemble de pluie XL','','Opsial',1,'','UNITE',1,0.0,'',2,1,2,0,0,''),
        ('ART-038','🦺 Vêtements de travail','Chauffrettes à main','Handwormer','',1,'','UNITE',1,0.0,'',2,2,4,0,0,''),
        ...
        ('ART-070','Outillage Manuel','Coffret tournevis','','',1,'','UNITE',1,0.0,'',1,1,1,0,3,'Partiellement remplie'),
        ...
        ('ART-102','Outillage Manuel','Pointeaux PP1','PP1 6001131','',1,'','UNITE',1,0.0,'',0,1,3,0,0,'À vérifier'),
        ...
        ('ART-110','Outillage Électroportatif','Tronçonneuse à rail MTZ modèle 350AS/400AS','','',1,'','UNITE',1,0.0,'',3,1,2,0,0,'Avec guide'),
        ...
        ('ART-131','🔋 Batteries & Piles','Batterie Cembre LIHD 36V 8Ah','','Cembre',1,'','UNITE',1,0.0,'',5,2,3,0,0,'Rechargeable'),
        ...
        ('ART-140','🔋 Batteries & Piles','Pile GLR20 6LR20 Cecasa SNCF','0.816.8652','Cecasa',1,'','UNITE',1,0.0,'',3,2,4,0,0,'Pour lanternes'),
        ('ART-141','🔋 Batteries & Piles','Pile PCFF-200 lanterne de queue','0.816.8651','MFI',1,'','UNITE',1,0.0,'',2,2,4,0,0,'Pour lanternes'),
        ...
        ('ART-144','Éclairage & Électricité','Projecteur batterie 6V Varta BL40','','Varta',1,'','UNITE',1,0.0,'',4,1,2,0,0,'2 unités x2'),
        ...
        ('ART-160','📏 Mesure & Traçage','Jauge de précision N°071351 42','071351 42','',1,'','UNITE',1,0.0,'',0,1,1,0,0,'À COMMANDER'),
        ...
        ('ART-182','Équipements Spéciaux','Cadenas à code Abus 145/40','','Abus',1,'','UNITE',1,0.0,'',0,2,4,0,0,'À COMMANDER'),
        ('ART-183','Équipements Spéciaux','Cadenas à code Abus Nautic 180','','Abus',1,'','UNITE',1,0.0,'',0,2,4,0,0,'À COMMANDER'),
        ...
        ('ART-187','Abrasifs & Disques','Disque Makita 300x3,5x20mm','','Makita',2,'A3','BOITE',1,0.0,'',0,2,5,0,0,'À COMMANDER'),
        ('ART-188','Abrasifs & Disques','Disque 320x3,2x22 Xhander','','Xhander',2,'A3','BOITE',1,0.0,'',0,2,4,0,0,'À COMMANDER'),
        ('ART-189','Abrasifs & Disques','Disque 230x2,5x22,3 Tyrolit','','Tyrolit',2,'A2','BOITE',1,0.0,'',2,2,4,0,0,''),
        ('ART-190','Lubrifiants & Produits','Nettoyant freins 5L','0890 108 715','',2,'A3','BIDON',1,0.0,'',0,1,2,0,0,'Rupture'),
        ...
        ('ART-194','Lubrifiants & Produits','Huile filante pour chaîne 5L','','',2,'A3','BIDON',1,0.0,'',0,1,2,0,0,'Rupture'),
        ...
        ('ART-200','Lubrifiants & Produits','Liquide de refroidissement LR21','8172308','',2,'AU SOL','UNITE',1,0.0,'',0,1,1,0,0,'Stock bas'),
        ...
        ('ART-207','Lubrifiants & Produits','Gel hydroalcoolique Bactimains','','Garcin Bactinyl',2,'A4','UNITE',1,0.0,'',0,1,2,0,0,'Stock bas'),
        ...
        ('ART-220','Conditionnement & Rangement','Film transparent','','',2,'A2','ROULEAU',1,0.0,'',0,2,4,0,0,'À COMMANDER'),
        ...
        ('ART-239','Fixations & Visserie','Boulon M10x60 Norme BN21200','BN21200','Bossards',3,'A2','UNITE',1,0.0,'',0,10,20,0,0,'À commander'),
        ('ART-240','Fixations & Visserie','Boulon M14x50','','',3,'','UNITE',1,0.0,'',19,5,10,0,0,''),
        ('ART-241','Fixations & Visserie','Vis BTR M16x2,2','','',3,'A2','UNITE',1,0.0,'',0,5,10,0,0,'À commander'),
        ('ART-242','Fixations & Visserie','Vis BTR 20x140 clé 17','','',3,'A2','UNITE',1,0.0,'',0,5,10,0,0,'À commander'),
        ...
        ('ART-245','Fixations & Visserie','Vis M10x60','005791060','Würth',3,'A3','BOITE',1,0.18,'',0,3,6,0,0,'À commander'),
        ('ART-246','Fixations & Visserie','Vis entretoise M10x70','','Index',3,'B3','UNITE',1,0.0,'',15,3,6,0,0,'À trappe'),
        ('ART-247','Fixations & Visserie','Vis + mèche','','',3,'B3','UNITE',1,0.0,'',90,10,20,0,0,''),
        ('ART-248','Fixations & Visserie','Écrou M10x150 Lanfranco','ERM100150ZHST02','J.Lanfranco',3,'A2','BOITE',1,0.0,'',0,3,6,0,0,'À commander'),
        ...
        ('ART-252','Fixations & Visserie','Écrou hexagonal combiné M10 Bossards','14F45000009','Bossards',3,'A2','BOITE',1,0.0,'',0,5,10,0,0,'À commander'),
        ...
        ('ART-266','Outillage Électroportatif','Fraise 23 TCT Rail RAPTR230','RAPTR230/SCRWC23','Doga',3,'A2','UNITE',1,0.0,'',0,10,50,0,0,'À commander'),
        ...
        ('ART-271','Abrasifs & Disques','Disque métal 300x3,8x20','','Masterpro',3,'','BOITE',1,0.0,'',0,2,4,0,0,'À commander'),
        ('ART-272','Abrasifs & Disques','Disque métal 300x3,5x21 Tyrolit','','Tyrolit',3,'A3','BOITE',1,0.0,'',0,2,4,0,0,'À commander'),
        ...
        ('ART-275','Outillage Ferroviaire','Cric manuel Strail','','Strail',3,'B4','UNITE',1,0.0,'',0,1,2,0,0,'À commander'),
        ...
        ('ART-329','Sikatop 122 FR bidon 5L','BIDON 5L','Sika','SUR PALETTE',4,'1 bidon = 5L','UNITE',1,0.0,'',0,5,0,0,0,''),
        ('ART-330','Sikatop 122 FR sac 30kg','SAC 30 KG','Sika','SUR PALETTE',4,'1 sac = 30kg','UNITE',1,0.0,'',0,5,0,0,0,''),
        ('ART-331','Fourreaux rouge 50M','FAMALEX ROUGE 63','','',4,'50M/rouleau','UNITE',1,0.0,'',0,2,0,0,0,''),
        ('ART-332','Bidim noir 25M','TERRAM','Terram','',4,'25M/rouleau','UNITE',1,0.0,'',0,10,0,0,0,''),
        ('ART-333','Bidim gris 50M','50M','','',4,'50M/rouleau','UNITE',1,0.0,'',0,5,0,0,0,''),
        ('ART-334','Bidim Teram bleu','TERAM BLEU','Teram','',4,'','UNITE',1,0.0,'',0,5,0,0,0,''),
        ('ART-335','Eclisse Tanconi','PAIRE','','',4,'Vendu à la paire','UNITE',1,0.0,'',0,4,0,0,0,''),
        ('ART-336','SAM (1 jaune+1 bleu+1 orange)','1 JAUNE+1 BLEU+1 ORANGE','','',4,'','UNITE',1,0.0,'',0,2,0,0,0,''),
        ('ART-337','Enrobé à froid noir 25kg','25KG','','',4,'1 bidon = 25kg','UNITE',1,0.0,'',0,4,0,0,0,''),
        ('ART-338','Sac écrou+rondelle+boulon','SAC DE 12','','',4,'1 sac = 12 pcs','UNITE',1,0.0,'',0,10,0,0,0,'')
    ]
